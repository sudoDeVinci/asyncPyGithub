    ...
    "oneOf": [
        {
            ...
            "properties": {
                ...
                "name": {"type": ["string", "null"], "examples": ["monalisa octocat"]},
                "company": {"type": ["string", "null"], "examples": ["GitHub"]},
                "blog": {
                    "type": ["string", "null"],
                    "examples": ["https://github.com/blog"],
                },
                "location": {"type": ["string", "null"], "examples": ["San Francisco"]},
                "email": {
                    "type": ["string", "null"],
                    "format": "email",
                ...
                "bio": {"type": ["string", "null"], "examples": ["There once was..."]},
                "twitter_username": {
                    "type": ["string", "null"],
                    "examples": ["monalisa"],
                },
                ...
                "two_factor_authentication": {"type": "boolean", "examples": [True]},
                "plan": {
                    "type": "object",
                    "properties": {
...
SimpleUserJSONSchema = {
    ...
    "items": {
        ...
        "properties": {
            ...
            "type": {"type": "string", "examples": ["User"]},
            "site_admin": {"type": "boolean"},
            "starred_at": {"type": "string", "examples": ['"2020-07-09T00:17:55Z"']},
            "user_view_type": {"type": "string", "examples": ["public"]},
        },
        "required": [
            "avatar_url",
            "events_url",
